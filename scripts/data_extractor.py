...
class DataExtractor:
    ...
    def extract_data_from_excel(self):
        ...
        input_columns.to_csv('input.csv', index=False) # TO DO:mudar o local onde salva os arquivos??
        ...
        output_columns.to_csv('output.csv', index=False) # TO DO:mudar o local onde salva os arquivos??
