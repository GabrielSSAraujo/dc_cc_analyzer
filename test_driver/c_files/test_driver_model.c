...
int main()
{
    ...
    // Criar arquivos CSV
    FILE *input_file = fopen("./test_vector/input.csv", "r");
    FILE *output_file = fopen("./test_vector/output.csv", "r");
    FILE *results_file = fopen("./test_vector/results.csv", "w"); // arquivo de saída final (original "output.csv" + resultados após executar o SUT)
